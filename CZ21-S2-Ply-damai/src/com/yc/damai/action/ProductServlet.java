...
public class ProductServlet extends BaseServlet {
	...
	public void queryByCid(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		append(response, pdao.queryByCid(cid));
	}
	
	public void queryByCsid(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String csid = request.getParameter("csid");
		append(response, pdao.queryByCid(csid));
	}
}
